...
public class SendBoundary extends AsyncTask<Void, Void, Integer> {

    private Exception exception;

    private Handler mCallersHandler;

    private Location mTopLeft;
    private Location mBottomRight;

    // Return codes
    public static final int MSG_FINISHED = 1001;

    public SendBoundary(Handler handler, Location topLeft, Location bottomRight) {
    ...
    protected Integer doInBackground(Void... params) {
        ...
        try {
            ...
            jsonObject.put("startLat", mTopLeft.getLatitude());
            jsonObject.put("startLng", mTopLeft.getLongitude());
            jsonObject.put("endLat", mBottomRight.getLatitude());
            jsonObject.put("endLng", mBottomRight.getLongitude());

            int httpStatus = postJSONObjectToURL("https://obscure-spire-79030.herokuapp.com/api/boundary", jsonObject);
